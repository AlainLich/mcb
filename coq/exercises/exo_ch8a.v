...
elim x; elim y =>//= H; have:= haveFun _ _ (@nat_of_ord _) _ _ H; rewrite !inordK =>//=.   
Qed.
...
Proof. 
     ...
     rewrite pcan_wo4 /ord_enum  mem_pmap_sub -/(iota 0 4) mem_iota add0n => ->.
     by case : (w2o elt) => m Hineq => //=; rewrite Hineq.
Qed.
...
(* The detail testing shows how to resolve the various terms in isolation *)
