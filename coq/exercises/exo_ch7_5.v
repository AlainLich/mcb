...
From HB Require Import structures.
  ...
  (* This comes from Book 7.5 p. 147.
     Largely obsoleted by current version of library ! 
     TBD Skipped ... TBD *)
     
Section FinFunDef.
  (* For the librarie's version, see mathcomp.ssreflect.finfun.finfun_of *) 
  ...
  Canonical finfun_subType := Eval hnf in [isNew for fgraph].
...
(* 
 ***************************************************************************
     TBD TBD THE LIBRARY VERSION MAKES THIS MOSTLY OBSOLETE, TO BE REDONE LATER
 ***************************************************************************     
